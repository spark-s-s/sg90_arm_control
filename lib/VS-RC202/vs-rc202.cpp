...
int getMotionNumber() { return current_motion_number; }

void resetMotionStatus() { motion_status = 0; }
...
int readServoLimitL() { return read2byte(SV_L_LIMIT); }

// Read current servo clockwise limit
int readServoLimitH() { return read2byte(SV_H_LIMIT); }
...
int readServoMovingTime() { return read2byte(SV_MV_TIME); }
